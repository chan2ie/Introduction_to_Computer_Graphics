...
#define RACINGCAR_POINT 0
#define RACINGCAR_WHEEL 1

GLfloat RC_color[2][3] = { {1, 1, 1}, {0,0,0} };

GLfloat racingcar_body[8][2] = { {-5, 10}, {-35, 11}, {-50, 9}, {-70, 3}, {-71, 2}, {-70, 1}, {-24, -4}, {-1, -5}};
GLfloat racingcar_body5[4][2] = { {-5, 10}, {-1, -5}, {13, -5}, {13, 14} };
GLfloat racingcar_body1[6][2] = { {13, -5}, {51, -5}, {51, 6}, {18, 21}, {13, 22}, {13, 14} };
GLfloat racingcar_body2[6][2] = { {51, -5}, {64, -5}, { 66, -4 }, {66, 0}, {65, 1}, {51, 1} };
GLfloat racingcar_body3[8][2] = { {65, 1}, {69, 3}, {69, 15}, {61, 17}, {58, 21}, {59, 9}, {51, 13}, {51, -5} };
GLfloat racingcar_body4[6][2] = { {59, 9}, {58, 21}, {50, 21}, {49, 14}, {50, 13}, {51, 13} };
GLfloat racingcar_point[9][2] = { {-1, -3}, {-2, -2}, {-9, -1}, {-15, 1}, {-23, 5}, {-24, 1}, {-24, -3}, {-23, -7}, {-2, -7} };
GLfloat racingcar_body_point1[7][2] = { {-47, -3}, {-47, 2}, {-63, 2}, {-65, 0}, {-67, -3}, {-66, -4}, {-48, -4} };
GLfloat racingcar_body_point2[7][2] = { {40, 2}, {25, 8}, {10, 8}, {-2, 7}, {-1, 3}, {-1, -5}, {40, -5} };
GLfloat racingcar_body_deep1[4][2] = { {-1, -5}, {-2, -8}, {35, -8}, {35, -5} };
GLfloat racingcar_body_deep2[5][2] = { {11, 13}, {13, 15}, {13, 24}, {9, 24}, {9, 13} };
GLfloat racingcar_back_wheel[16][2] = { {-24, 0}, {-25, 4}, {-27, 7}, {-30, 9}, {-34, 10}, {-38, 9}, {-41, 7}, {-43, 4}, {-44, 0},
	{-43, -4}, {-41, -7}, {-38, -9}, {-34, -10} , {-30, -9}, {-27, -7}, {-25, -4} };
GLfloat racingcar_front_wheel[16][2] = { {61, 0}, {60, 4}, {58, 7}, {55, 9}, {51, 10}, {47, 9}, {44, 7}, {42, 4}, {41, 0},
	{42, -4}, {44, -7}, {47, -9}, {51, -10} , {55, -9}, {58, -7}, {60, -4} };

GLuint VBO_RC, VAO_RC;

void prepare_rc() {

	GLsizeiptr buffer_size = sizeof(racingcar_body) + sizeof(racingcar_body5) + sizeof(racingcar_body1) + sizeof(racingcar_body2) + sizeof(racingcar_body3) + sizeof(racingcar_body4) +
		sizeof(racingcar_front_wheel) + sizeof(racingcar_back_wheel) + sizeof(racingcar_point) + sizeof(racingcar_body_deep1) + sizeof(racingcar_body_deep2) + 
		sizeof(racingcar_body_point1) + sizeof(racingcar_body_point2);

	glGenBuffers(1, &VBO_RC);

	glBindBuffer(GL_ARRAY_BUFFER, VBO_RC);
	glBufferData(GL_ARRAY_BUFFER, buffer_size, NULL, GL_STATIC_DRAW); // allocate buffer object memory
	
	glBufferSubData(GL_ARRAY_BUFFER, 0, sizeof(racingcar_body), racingcar_body);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(racingcar_body), sizeof(racingcar_body5), racingcar_body5);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(racingcar_body) + sizeof(racingcar_body5), sizeof(racingcar_body1), racingcar_body1);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(racingcar_body) + sizeof(racingcar_body5) + sizeof(racingcar_body1), sizeof(racingcar_body2), racingcar_body2);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(racingcar_body) + sizeof(racingcar_body5) + sizeof(racingcar_body1) + sizeof(racingcar_body2), sizeof(racingcar_body3), racingcar_body3);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(racingcar_body) + sizeof(racingcar_body5) + sizeof(racingcar_body1) + sizeof(racingcar_body2) + sizeof(racingcar_body3), sizeof(racingcar_body4), racingcar_body4);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(racingcar_body) + sizeof(racingcar_body5) + sizeof(racingcar_body1) + sizeof(racingcar_body2) + sizeof(racingcar_body3) + sizeof(racingcar_body4),
		sizeof(racingcar_point), racingcar_point);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(racingcar_body) + sizeof(racingcar_body5) + sizeof(racingcar_body1) + sizeof(racingcar_body2) + sizeof(racingcar_body3) + sizeof(racingcar_body4) +
		sizeof(racingcar_point), sizeof(racingcar_body_point1), racingcar_body_point1);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(racingcar_body) + sizeof(racingcar_body5) + sizeof(racingcar_body1) + sizeof(racingcar_body2) + sizeof(racingcar_body3) + sizeof(racingcar_body4) +
		sizeof(racingcar_point) + sizeof(racingcar_body_point1), sizeof(racingcar_body_point2), racingcar_body_point2);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(racingcar_body) + sizeof(racingcar_body5) + sizeof(racingcar_body1) + sizeof(racingcar_body2) + sizeof(racingcar_body3) + sizeof(racingcar_body4) +
		sizeof(racingcar_point) + sizeof(racingcar_body_point1) + sizeof(racingcar_body_point2), sizeof(racingcar_body_deep1), racingcar_body_deep1);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(racingcar_body) + sizeof(racingcar_body5) + sizeof(racingcar_body1) + sizeof(racingcar_body2) + sizeof(racingcar_body3) + sizeof(racingcar_body4) + 
		sizeof(racingcar_point) + sizeof(racingcar_body_point1) + sizeof(racingcar_body_point2) + sizeof(racingcar_body_deep1), sizeof(racingcar_body_deep2), racingcar_body_deep2);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(racingcar_body) + sizeof(racingcar_body5) + sizeof(racingcar_body1) + sizeof(racingcar_body2) + sizeof(racingcar_body3) + sizeof(racingcar_body4) + 
		sizeof(racingcar_point) + sizeof(racingcar_body_point1) + sizeof(racingcar_body_point2) + sizeof(racingcar_body_deep1) + sizeof(racingcar_body_deep2), sizeof(racingcar_front_wheel), racingcar_front_wheel);
	glBufferSubData(GL_ARRAY_BUFFER, sizeof(racingcar_body) + sizeof(racingcar_body5) + sizeof(racingcar_body1) + sizeof(racingcar_body2) + sizeof(racingcar_body3) + sizeof(racingcar_body4) + 
		sizeof(racingcar_point) + sizeof(racingcar_body_point1) + sizeof(racingcar_body_point2) + sizeof(racingcar_body_deep1) + sizeof(racingcar_body_deep2) + sizeof(racingcar_front_wheel), sizeof(racingcar_back_wheel), racingcar_back_wheel);
...
void draw_rc(int r, int g, int b) {
	float body_color[3] = { r / 255.0f, g / 255.0f, b / 255.0f };
	float body_point[3] = { (r - 20) / 255.0f,(g - 20) / 255.0f, (b - 20) / 255.0f };
	float body_deep[3] = { (r - 50) / 255.0f,(g - 50) / 255.0f, (b - 50) / 255.0f };

	glBindVertexArray(VAO_RC);

	glUniform3fv(loc_primitive_color, 1, body_color);
	glDrawArrays(GL_TRIANGLE_FAN, 0, 8);
	glUniform3fv(loc_primitive_color, 1, body_color);
	glDrawArrays(GL_TRIANGLE_FAN, 8, 4);
	glUniform3fv(loc_primitive_color, 1, body_color);
	...
	glUniform3fv(loc_primitive_color, 1, RC_color[RACINGCAR_POINT]);
	glDrawArrays(GL_TRIANGLE_FAN, 38, 9);

	glUniform3fv(loc_primitive_color, 1, body_point);
	glDrawArrays(GL_TRIANGLE_FAN, 47, 7);

	glUniform3fv(loc_primitive_color, 1, body_point);
	glDrawArrays(GL_TRIANGLE_FAN, 54, 7);

	glUniform3fv(loc_primitive_color, 1, body_deep);
	glDrawArrays(GL_TRIANGLE_FAN, 61, 4);

	glUniform3fv(loc_primitive_color, 1, body_deep);
	glDrawArrays(GL_TRIANGLE_FAN, 65, 5);

	glUniform3fv(loc_primitive_color, 1, RC_color[RACINGCAR_WHEEL]);
	glDrawArrays(GL_TRIANGLE_FAN, 70, 16);

	glUniform3fv(loc_primitive_color, 1, RC_color[RACINGCAR_WHEEL]);
	glDrawArrays(GL_TRIANGLE_FAN, 86, 16);
